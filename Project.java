...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter) {
        ...
        newcustomer.setBackground(Color.GRAY);
        ...
        customerdetails.setBackground(Color.GRAY);
        ...
        depositdetails.setBackground(Color.GRAY);
        ...
        calculatebill.setBackground(Color.GRAY);
